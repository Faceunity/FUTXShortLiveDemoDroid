...
public class RecordBottomLayout extends RelativeLayout implements View.OnClickListener {
    ...
    private void switchCamera() {
        ...
        mOnSwitchCameraListener.onSwitchCamera(mFrontCameraFlag);
    }
    ...
    public void setOnSwitchCameraListener(OnSwitchCameraListener mOnSwitchCameraListener) {
        this.mOnSwitchCameraListener = mOnSwitchCameraListener;
    }
    ...
    public interface OnSwitchCameraListener {
        void onSwitchCamera(boolean isFront);
    }
